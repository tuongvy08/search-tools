...
var TeamPermissions = (() => {
    ...
    const dependencies = { QUICK_QUOTE: ['VIEW_PRICE'], CHECK_LICENSE: ['SEARCH_BY_CAS', 'VIEW_COMPLIANCE'], ADVANCED_SEARCH: ['SEARCH_BY_CAS'], EXPORT: ['VIEW_COMPLIANCE'] };
    ...
    async function quoteExport(selections, source, context = {}) {
        const body = new FormData();
        body.append('selections', JSON.stringify(selections));
        body.append('source', String(source || ''));
